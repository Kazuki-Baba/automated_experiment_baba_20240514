...
INSERT INTO `actions` VALUES (1,'on','--on',0,0,NULL,NULL),(2,'get the value','--get',0,1,NULL,NULL),(3,'off','--off',0,0,NULL,NULL),(4,'waiting','wait',1,0,NULL,NULL),(5,'set infusion rate and run','--iraterun',2,0,NULL,NULL),(6,'set withdraw rate','--wrate',2,0,NULL,NULL),(7,'infusion run','--irun',0,0,NULL,NULL),(8,'withdraw run','--wrun',0,0,NULL,NULL),(9,'change position','--changePos',1,0,NULL,NULL),(10,'wait for steady-sate','--judge',0,0,NULL,NULL),(11,'set temp. and run','--setrun',1,0,NULL,NULL),(12,'ready and set sampling time','--ready',1,0,NULL,NULL),(13,'sampling','--sample',0,0,NULL,NULL),(14,'alert','alert',1,0,NULL,NULL),(15,'set flow rate[mL/min] and run','--run',1,0,NULL,NULL),(16,'set temperature','--set',1,0,NULL,NULL),(17,'set rate [rpm]','--rate',1,0,NULL,NULL),(18,'set rate [mL/min]','--rateset',2,0,NULL,NULL),(19,'set temp [`C] and wait for steady state','--setandsstate',1,0,NULL,NULL);
...
INSERT INTO `device_types` VALUES (1,'testType',NULL,NULL),(2,'syringePump',NULL,NULL),(3,'6-way valve',NULL,NULL),(4,'thermometer',NULL,NULL),(5,'temperature controller',NULL,NULL),(6,'No device',NULL,NULL),(7,'fraction collector',NULL,NULL),(8,'PDA',NULL,NULL),(9,'Mass Flow Controler',NULL,NULL),(10,'Digital Temp Controller',NULL,NULL),(11,'Mixer',NULL,NULL),(12,'Plunger Pump',NULL,NULL),(13,'Smoothflow Pump',NULL,NULL),(14,'HPLC',NULL,NULL);
